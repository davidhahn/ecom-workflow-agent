...
const WRAPPER_CLASSES = [
  ...
  "[&>*+*]:mt-3",
  "[&_h1]:mt-8 [&_h1]:text-xl [&_h1]:font-semibold [&_h1]:first:mt-0",
  "[&_h2]:mt-7 [&_h2]:border-t [&_h2]:border-black/10 [&_h2]:pt-5 [&_h2]:text-lg [&_h2]:font-semibold dark:[&_h2]:border-white/10",
  "[&_h3]:mt-5 [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:uppercase [&_h3]:tracking-wide [&_h3]:text-gray-500 dark:[&_h3]:text-gray-400",
  "[&_p]:leading-relaxed",
  "[&_ul]:list-disc [&_ol]:list-decimal [&_li]:ml-5 [&_li+li]:mt-1",
