// From beUI (beui.dev/components/motion/tabs), unmodified apart from the
// two import paths (EASE_OUT, cn) pointing at this app's own lib files.
"use client";
  ...
  if (variant === "underline") {
    return (
      <button
        ...
        className={cn(
          "relative isolate inline-flex min-h-[44px] items-center px-3 pt-1 pb-2.5 -mb-px text-sm font-medium transition-colors",
